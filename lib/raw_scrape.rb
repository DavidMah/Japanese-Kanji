...
module RawScraper
  ...
  def read_kanji
    kanji_json = []
    (1..799).each do |index|
      unformatted_definitions = scrape_definitions(index)
      formatted_definitions   = format_definitions(unformatted_definitions)
